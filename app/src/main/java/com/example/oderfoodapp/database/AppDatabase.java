...
@Database(entities = {Food.class, Category.class, User.class, Feedback.class, Cart.class, History.class, FavoriteFood.class, HistoryDetail.class, Voucher.class, VoucherDetail.class}, version = 15)
