...
import com.example.oderfoodapp.recyclerViewAdapter.DetailFoodOrderAdapter;
...
public class orderDetail extends Fragment {
    ...
    int transactionID;
    // Khai bao Adapter
    DetailFoodOrderAdapter detailFoodOrderAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        detailFoodOrderAdapter = new DetailFoodOrderAdapter(mainActivity,historyDetailList);
        listMon.setLayoutManager(new LinearLayoutManager(mainActivity,LinearLayoutManager.VERTICAL,false));
        listMon.setAdapter(detailFoodOrderAdapter);
