...
public class DetailFoodOrderAdapter extends RecyclerView.Adapter<DetailFoodOrderAdapter.DetailFoodHolder> {
    ...
    public DetailFoodOrderAdapter(Context context, List<HistoryDetail> list){
    ...
    public DetailFoodHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemmoninpayment,parent,false);
